/*
  ...
  1. New Tables
    - `meals` table for storing meal information
      - `id` (uuid, primary key)
      - `name` (text, required)
      - `description` (text)
      - `category` (text, enum: breakfast, lunch, dinner, snack)
      - `calories` (integer, positive)
      - `protein` (integer, non-negative)
      - `carbs` (integer, non-negative)
      - `fat` (integer, non-negative)
      - `image_url` (text)
      - `recipe` (text)
  ...
  3. Sample Data
    - Insert Mediterranean-focused sample meals
*/
